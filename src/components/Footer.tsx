export default function Footer() {
  return (
    <footer className="relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8 border-t border-white/20 bg-transparent">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-2">
            <h3 className="text-2xl font-bold mb-4 text-white">NutriPlan</h3>
            <p className="text-white/70 mb-4 max-w-md">
              Transforming nutrition with AI-powered meal planning, recipe discovery, and progress tracking.
            </p>
